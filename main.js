...
var SketchName = quick_draw_data_set[random_number];

document.getElementById("draw").innerHTML = "Sketch to be drawn : "+SketchName;
...
function gotResult(error, results){
  ...
  console.log(results);
   ...
   document.getElementById('UrSketch').innerHTML = 'Your sketch: '+results[0].label;
